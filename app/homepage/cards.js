    ...
    <div className="flex items-center justify-center">
      <div className="my-auto h-[480px] overflow-y-auto [&::-webkit-scrollbar]:hidden rounded-2xl ">
        <div className="flex flex-col  space-y-4">
          <div className="lg:h-[377px] lg:w-[840px] h-[378px] w-[320px] bg-[#A94949] m-2 rounded-2xl p-8 flex lg:flex-row flex-col items-center justify-center ">
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center text-center p-5">
              <div className="font-bold text-base md:text-h3 leading-tight">
            ...
            <img
              className="ml-6 lg:h-[305px] lg:w-[212px] h-[223px] "
              src="/assets/starter/1.png"
            ></img>
          </div>
          <div className="lg:h-[377px] lg:w-[840px] h-[325px] w-[378px] bg-[#5ED46A] m-2 rounded-2xl p-8 flex lg:flex-row flex-col justify-center items-center rotate-2">
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center text-center p-5">
              <div className="font-bold text-base md:text-h3 leading-tight">
          ...
          <div className="lg:h-[377px] lg:w-[840px] h-[325px] w-[378px] bg-[#487FD7] m-2 rounded-2xl p-8 flex lg:flex-row flex-col items-center justify-center -rotate-2">
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center text-center p-5">
              <div className="font-bold text-base md:text-h3 leading-tight">
          ...
          <div className="lg:h-[377px] lg:w-[840px] h-[325px] w-[378px] bg-[#5CAAB6] m-2 rounded-2xl p-8 flex lg:flex-row flex-col justify-center rotate-1">
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center text-center p-5">
              <div className="font-bold text-base md:text-h3 leading-tight">
